...
export default async function BrowsePage({ searchParams }: BrowsePageProps) {
    ...
    // Si deseas usar isMobile para algo más, puedes conservarlo
    ...
    try {
        ...
        try {
            content = isTV
                ? await filterAvailableSeries(contentData.results)
                : await filterAvailableMovies(contentData.results);
        } catch {
    ...
    return (
        <div className="space-y-8 pb-20">
            ...
            {/* Filtros y contenido */}
            {/* El Suspense se eliminó porque FilterBar y MovieGrid reciben datos del servidor
                y no realizan fetching asíncrono propio que requiera suspenso. */}
