...
import { Play, Star, Clock, Calendar, Heart, ArrowLeft, Layers } from 'lucide-react';
                ...
                <div className="flex gap-12 items-start">
                    ...
                    <div className="flex-1 max-w-4xl space-y-6">
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            <button className="flex items-center gap-3 px-8 py-4 bg-primary text-white rounded-xl font-bold text-xl hover:bg-primary-hover transition-colors tv-focusable focus:scale-105">
                                <Play className="w-6 h-6 fill-current" />
                                Ver Ahora
                            </button>

                            {trailer && (
                                <button className="flex items-center gap-3 px-8 py-4 bg-white/10 text-white rounded-xl font-bold text-xl hover:bg-white/20 transition-colors tv-focusable focus:scale-105 border border-white/10">
                                    <Play className="w-6 h-6" />
                                    Trailer
                                </button>
                            )}

                            <button className="p-4 bg-white/10 text-white rounded-xl hover:bg-white/20 transition-colors tv-focusable focus:scale-105 border border-white/10">
                ...
                {cast.length > 0 && (
                    <div className="mt-16">
                        ...
                        <div className="flex gap-6 overflow-x-auto pb-8 scrollbar-hide px-2 -mx-2">
                            {cast.map((person) => (
                                <div key={person.id} className="w-40 flex-shrink-0 tv-focusable rounded-xl focus:scale-105 transition-transform">
